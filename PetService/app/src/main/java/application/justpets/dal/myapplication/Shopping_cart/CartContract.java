...
public class CartContract {
     ...
     * device.
     */
    public static final String CONTENT_AUTHORITY = "application.justpets.dal.myapplication";
     ...
     * Each entry in the table represents a single fragrance.0
     */
    public static final class CartEntry implements BaseColumns {
       ...
       public static final Uri CONTENT_URI_CART = Uri.withAppendedPath(BASE_CONTENT_URI, PATH_CART);
        ...
        /**
         * The MIME type of the {@link #} for a list of fragrance.
         */
