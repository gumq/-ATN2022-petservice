...
public class ServiceSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot usersnapshot : dataSnapshot.getChildren())
                {
                    ...
                    count++;
                    if(!samplesearch.getCategory().toString().equalsIgnoreCase("Dog Walker") && !samplesearch.getCategory().toString().equalsIgnoreCase("User"))
                    {
        ...
        if(walker_list!=null)
        {
            ...
            walkerlist = (ListView)findViewById(R.id.Walkerlist);
            AdapterWalker adapterWalker = new AdapterWalker(ServiceSearch.this,0,walker_list);
        ...
        walkerlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent2 = new Intent(ServiceSearch.this, WalkerProfile_Activity.class);
    ...
    public void walkerdatetimepicker()
    {
        ...
        btn_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(ServiceSearch.this,d, dateTime.get(Calendar.YEAR),dateTime.get(Calendar.MONTH),dateTime.get(Calendar.DAY_OF_MONTH)).show();
            }
        ...
        btn_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new TimePickerDialog(ServiceSearch.this, t, dateTime.get(Calendar.HOUR_OF_DAY), dateTime.get(Calendar.MINUTE), true).show();
            }
