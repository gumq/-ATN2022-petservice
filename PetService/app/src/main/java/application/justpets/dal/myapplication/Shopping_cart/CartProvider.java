...
public class CartProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "m" will map to the
        // integer code {@link #fragrance}. This URI is used to provide access to MULTIPLE rows
        // of the fragrance table.
        sUriMatcher.addURI(CartContract.CONTENT_AUTHORITY, CartContract.PATH_FRAGRANCE, FRAGRANCES);

        sUriMatcher.addURI(CartContract.CONTENT_AUTHORITY, CartContract.PATH_CART, CART);
        ...
        sUriMatcher.addURI(CartContract.CONTENT_AUTHORITY, CartContract.PATH_FRAGRANCE + "/#", FRAGRANCE_ID);
        sUriMatcher.addURI(CartContract.CONTENT_AUTHORITY, CartContract.PATH_CART + "/#", CART_ID);

    }

    /** Database helper object */
    private CerDbHelper fragranceDbHelper;

    @Override
    public boolean onCreate() {
        fragranceDbHelper = new CerDbHelper(getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            case FRAGRANCES:
                ...
                cursor = database.query(CartContract.CartEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case CART:
                cursor = database.query(CartContract.CartEntry.CART_TABLE, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case CART_ID:
                selection = CartContract.CartEntry._CARTID + "=?";
    ...
    private Uri insertCart(Uri uri, ContentValues values) {
        ...
        long id = database.insert(CartContract.CartEntry.CART_TABLE, null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match) {
            ...
            case CART_ID:
                ...
                cartDeleted = db.delete(CartContract.CartEntry.CART_TABLE, "_id=?", new String[]{id});
                break;
            default:
