...
public class CartActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    MainCartAdapter maincartAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maincartAdapter = new MainCartAdapter(this);
        mRecyclerView.setAdapter(maincartAdapter);
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                Uri uri = CartContract.CartEntry.CONTENT_URI_CART;
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                CartContract.CartEntry._CARTID,
                CartContract.CartEntry.COLUMN_CART_NAME,
                CartContract.CartEntry.COLUMN_CART_IMAGE,
                CartContract.CartEntry.COLUMN_CART_QUANTITY,
                CartContract.CartEntry.COLUMN_CART_TOTAL_PRICE,
        };

        // This loader will execute the ContentProvider's query method on a background thread
        return new CursorLoader(this,   // Parent activity context
                CartContract.CartEntry.CONTENT_URI_CART,   // Provider content URI to query
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        maincartAdapter.swapCursor(cursor);
    ...
    public double calculateTotal(Cursor cursor){
        ...
        {
            int price = cursor.getColumnIndex(CartContract.CartEntry.COLUMN_CART_TOTAL_PRICE);
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        maincartAdapter.swapCursor(null);
