...
public class DtoUser {
  //  private int id_user, user_type, status;
    private String name_user, email, cpf_user, password;
    //, address_user, complement, zipcode, phone_user, birth_date, img_user
...
//    }
    ...
    public DtoUser(String cpf_user, String password) {
        this.cpf_user= cpf_user;
        this.password = password;
    }
