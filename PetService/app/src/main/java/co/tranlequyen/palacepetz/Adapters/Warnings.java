...
import co.tranlequyen.palacepetz.Activitys.LoginActivity;
import co.tranlequyen.palacepetz.Activitys.MainActivity;

import co.tranlequyen.palacepetz.Activitys.RegisterAddressActivity;
...
//        });
 ...
 //      DtoSchedule schedule = new DtoSchedule(user.getCpf_user(), cd_schedule);
