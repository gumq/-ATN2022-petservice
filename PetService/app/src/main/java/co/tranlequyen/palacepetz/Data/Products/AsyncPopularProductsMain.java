...
import co.tranlequyen.palacepetz.Adapters.PopularProducts_Adapter;
...
public class AsyncPopularProductsMain extends AsyncTask {
   ...
   // private final int _IdUser;
    private final String cpf_usr;
    private PopularProducts_Adapter products_adapter;
    private final LottieAnimationView loadingPopularProducts;

    public AsyncPopularProductsMain(RecyclerView recyclerProducts, LottieAnimationView loadingPopularProducts, ArrayList<DtoProducts> arrayListDto, String _IdUser, Activity context) {
        this.recyclerProducts = recyclerProducts;
        this.context = context;
        this.cpf_usr = _IdUser;
        ...
        recyclerProducts.addOnItemTouchListener(new RecyclerItemClickListener(context, recyclerProducts,
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        goToDetails.putExtra("id_user", cpf_usr);
