...
import co.tranlequyen.palacepetz.Activitys.ProductDetailsActivity;
import co.tranlequyen.palacepetz.Adapters.Products_Adapter;
import co.tranlequyen.palacepetz.Methods.JsonHandler;

@SuppressWarnings({"rawtypes", "deprecation", "unchecked"})
@SuppressLint("StaticFieldLeak")
public class AsyncFilterProducts_Name extends AsyncTask {
    ...
    public AsyncFilterProducts_Name(RecyclerView recyclerProducts, SwipeRefreshLayout SwipeRefreshProducts, LottieAnimationView anim_loading_allProducts,
                                    ArrayList<DtoProducts> arrayListDto, Activity context, String nm_product) {
    ...
    protected Object doInBackground(Object[] objects) {
        String json =  JsonHandler.getJson("https://gumq.github.io/palacepetzapi/name.json");
